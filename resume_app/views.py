...
GITHUB_TOKEN = os.getenv("MISTRAL_API_KEY", "api-git") # Replace fallback in production
...
"""
        ...
        if not GITHUB_TOKEN or GITHUB_TOKEN == "api-git": # Check your specific placeholder
...
class AnalyzeResumeView(APIView):
    ...
    def analyze_resume_github(self, resume_text):
        ...
        try:
            ...
            client = Mistral(api_key="api-git", server_url="https://models.github.ai/inference")
            prompt_content = f"""
...
class ChatView(APIView):
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            try:
                token = "api-git"; endpoint = "https://models.github.ai/inference" ; model_name = "mistral-ai/mistral-small-2503"
...
GITHUB_TOKEN = os.environ.get("MISTRAL_API_KEY", "api-git") # <<< Replace hardcoded fallback in production
...
"""
        ...
        if not GITHUB_TOKEN or GITHUB_TOKEN == "api-git": # Check against your specific placeholder/fallback
...
"""
        ...
        if not GITHUB_TOKEN or GITHUB_TOKEN == "api-git": # Check your specific fallback
